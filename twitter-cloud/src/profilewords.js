...
var themes = [
    ...
    { name: 'Naranja',  background:'#FFFFFE', words:[ '#F58422', '#FACDA7', '#E47325', '#F4A261', '#F6B989' ], font:'Varela' },
    { name: 'Earth', background:'#FCFBF8', words:[ '#d4806d', '#cbc4ba', '#c2be98', '#e3cb92', '#695d4f' ], font:'Varela' }, 
    { name: 'Sueno', background:'#FCFBF8', words:[ '#5C3456', '#6C6263', '#B27F7E', '#A3B1B1', '#A78174' ], font:'Varela' }, 
    { name: 'Glow', background:'#444444', words:[ '#FF530D', '#E82C0C', '#FF0000', '#E80C7A', '#FF0DFF' ], font:'Varela' },   
    { name: 'Frost', background:'#FFFFFC', words:[ '#4B81A5', '#273F5A', '#C6DBF3', '#74A0BF', '#98C4DA' ], font:'Varela' },       
    { name: 'Ocean', background:'#F7F9F7', words:[ '#5C8C7E', '#47738c', '#8A9FB0', '#95AA99', '#2f4d57' ], font:'Varela' },
    { name: 'Beach',  background:'#FCFBF8', words:[ '#93ADB6', '#b6c6c6 ', '#ec6c52', '#f2b26f', '#ABC5CB' ], font:'Varela' },
    { name: 'Flight',  background:'#FCFBF8', words:[ '#DDA26E', '#EACDAD', '#ABC2BD', '#9C8E77', '#CBC4BA' ], font:'Varela' }, 
    { name: 'Ciruela',  background:'#FBF6F9', words:[ '#B37CB5', '#9552A2', '#6E2E7A', '#A895A9', '#773781' ], font:'Varela' },
    { name: 'Broadsheet',  background:'#FFFFFF', words:[ '#333333', '#555555', '#777777', '#999999', '#BBBBBB' ], font:'Varela' },
    { name: 'Darksheet',  background:'#333333', words:[ '#444444', '#555555', '#777777', '#999999', '#BBBBBB' ], font:'Varela' }
...
function renderCloud(){
    ...
    if( idField.value ){
        ...
        if( oauth_token ){                
            parameters =  'cloudType=' + CLOUD_TYPE;
        }
...
//    themeName.style.color = themes[selectedTheme].words[0];
    
//    themeName.textContent = "'" + themes[selectedTheme].name + "'";
    
    
    
//    $( ".btn-warning.active" ).css( "background", themes[selectedTheme].words[0] );
//    
//    sheet.insertRule( ".btn-warning:hover{ background:" + themes[selectedTheme].words[0] + ";}", ruleCount);
